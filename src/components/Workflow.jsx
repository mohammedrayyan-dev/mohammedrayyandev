...
const Workflow = () => {
  ...
  return (
    <>
        ...
        <div className="h-[60px] w-[60px] bg-blue-500/10 rounded-full flex items-center justify-center">
            <div className="max-w-[45px]">
                <Lightbulb className="w-full h-full text-blue-400" />
            </div>
        </div>
        <div className="w-[100px] h-[40px] bg-transparent backdrop-blur border border-white/10 flex items-center justify-center rounded-full">
            <h2 className="text-[#E6E8EB] text-lg font-semibold">
                Plan
            </h2>
        </div>
        </div>
        <p className="text-[#9CA3AF80] text-md pt-[6px] max-w-xs"> 
         ...
         <div className="flex flex-col gap-4">
        <div className="flex flex-row items-center gap-4">
        <div className="h-[60px] w-[60px] bg-purple-500/10 rounded-full flex items-center justify-center">
            <div className="max-w-[45px]">
        ...
        <p className="text-[#9CA3AF80] text-md pt-[6px] max-w-xs ">
         ...
         <div className="flex flex-col gap-4">
        <div className="flex flex-row items-center gap-4">
        <div className="h-[60px] w-[60px] bg-green-500/10 rounded-full flex items-center justify-center">
            <div className="max-w-[45px]">
        ...
        className={`w-[550px] flex flex-row items-center justify-start px-10 py-3 gap-6 rounded-2xl transition-all duration-300
        ${active === index ? "bg-[#4a66a360] border border-[#7AA2F7]"
            ...
            <p className="text-[#9CA3AF80] text-md pt-[6px]">
            {strat.description}
            </p>
            </div>
        </button>
